...
<html lang="en">
  <head>
    <
    <title>TechOnTap || Search Result</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2>Search result againt keyword "<?php echo $searchpname;?>"</h2>
                    </div>
                </div>
            </div>
        </div>
...
//Getting default page number
        ...
        $ret1=mysqli_query($con,"select COUNT(*) from  tblproduct where ProductName like '%$searchpname%'");
$total_rows = mysqli_fetch_array($ret1)[0];
$total_pages = ceil($total_rows / $no_of_records_per_page);                                                   
 $query=mysqli_query($con,"select * from tblproduct where ProductName like '%$searchpname%' LIMIT $offset, $no_of_records_per_page");
if($total_rows >0 ){
