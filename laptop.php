...
<html lang="en">
  <head>
    <
    <title>TechOnTap || Shop Laptop</title>
...
//Getting default page number
        ...
        $ret1=mysqli_query($con,"select COUNT(*) from  tblproduct where Type='Laptop'");
$total_rows = mysqli_fetch_array($ret1)[0];
$total_pages = ceil($total_rows / $no_of_records_per_page);                                                   
 $query=mysqli_query($con,"select * from tblproduct where Type='Laptop' LIMIT $offset, $no_of_records_per_page");
